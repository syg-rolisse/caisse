...
var spark2 = new ApexCharts(document.querySelector("#total-projects"), spark2);
spark2.render();
...
var spark3 = new ApexCharts(document.querySelector("#total-employee"), spark3);
spark3.render();
...
var spark4 = new ApexCharts(document.querySelector("#total-tasks"), spark4);
spark4.render();
...
var spark4 = new ApexCharts(document.querySelector("#total-earnings"), spark4);
spark4.render();
...
var options = {
  ...
  colors: ["rgb(132, 90, 223)", "rgba(132, 90, 223, 0.6)"],
  plotOptions: {
    bar: {
      colors: {
        ranges: [
