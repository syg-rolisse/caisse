...
export default function SubscriptionCountdownCard({ abonnements = [] }) {
      ...
      <div className="card custom-card fade-in tw-h-full tw-flex tw-items-center tw-justify-center">
        <div className="card-body">
          <div className="tw-flex tw-items-center">
            ...
            <div>
              <p className="tw-font-semibold tw-text-lg tw-text-red-700">Aucun Abonnement Actif</p>
            </div>
          </div>
        </div>
      </div>
  ...
  return (
    <div className="tw-border tw-border-gray-200 tw-rounded-lg fade-in tw-h-full tw-flex tw-flex-col">
